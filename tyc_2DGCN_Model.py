...
from tyc_2DGCN_Core import tyc_2DGCN_Core
from deepchem.models.losses import Loss, L2Loss, SparseSoftmaxCrossEntropy
import torch
import torch.nn.functional as F

class tyc_2DGCN_Model(TorchModel):
    def __init__(self,
               n_tasks: int=1,
        ...
        super(tyc_2DGCN_Model, self).__init__(model, loss=loss, output_types=output_types, **kwargs)
    ...
    def _prepare_batch(self, batch):
        ...
        _, labels, weights = super(tyc_2DGCN_Model, self)._prepare_batch(([], labels,
                                                               weights))
